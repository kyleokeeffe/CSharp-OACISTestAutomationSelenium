...
{
    internal class AppIntakeAutoGen
    {
		...
		public AppIntakeAutoGen(IWebDriver driver)
		{
			DriverHelper.WaitForPageLoad(driver);
			this.Driver = driver;
		}
		public AppIntakeAutoGen FillQuerytxt(string text)
		{
			Querytxt.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillApplicationReceivedDate_txtDatectl(string text)
		{
			ApplicationReceivedDate_txtDatectl.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillAppHourReceivedtxt(string text)
		{
			AppHourReceivedtxt.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillAppMinuteReceivedtxt(string text)
		{
			AppMinuteReceivedtxt.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillInformationLetterDate_txtDatectl(string text)
		{
			InformationLetterDate_txtDatectl.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillLetterSentDate_txtDatectl(string text)
		{
			LetterSentDate_txtDatectl.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillUnreconciledAmounttxt(string text)
		{
			UnreconciledAmounttxt.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillConsentDate_txtDatectl(string text)
		{
			ConsentDate_txtDatectl.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillSchoolBoardtxt(string text)
		{
			SchoolBoardtxt.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillSchoolNametxt(string text)
		{
			SchoolNametxt.SendKeys(text);
			return this;
		}
		public AppIntakeAutoGen FillApplicationCompletedDate_txtDatectl(string text)
		{
			ApplicationCompletedDate_txtDatectl.SendKeys(text);
			return this;
		}
	
		public AppIntakeAutoGen SelectOptionddlAMPM(int optionNum)
		{
		...
		public AppIntakeAutoGen SelectOptionddlIntakeProcess(int optionNum)
		{
			Actions action = new Actions(Driver);
		...
		public AppIntakeAutoGen SelectOptionddlAppType(int optionNum)
		{
			Actions action = new Actions(Driver);
		...
		public AppIntakeAutoGen SelectOptionddlAgeProof(int optionNum)
		{
			Actions action = new Actions(Driver);
		...
		public AppIntakeAutoGen SelectOptionddlResidencyProof(int optionNum)
		{
			Actions action = new Actions(Driver);
		...
		public AppIntakeAutoGen SelectOptionddlConsent(int optionNum)
		{
			Actions action = new Actions(Driver);
		...
		public AppIntakeAutoGen SelectOptionddlAttendingSchool(int optionNum)
		{
			Actions action = new Actions(Driver);
