...
{
    internal class ClientInformationAutoGen
    {
		...
		public ClientInformationAutoGen(IWebDriver driver)
		{
			DriverHelper.WaitForPageLoad(driver);
			this.Driver = driver;
		}
		public ClientInformationAutoGen FillQuerytxt(string text)
		{
			Querytxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillOAPClientNumbertxt(string text)
		{
			OAPClientNumbertxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillIIO_TransitionCodetxt(string text)
		{
			IIO_TransitionCodetxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillRegistrationDatetxt(string text)
		{
			RegistrationDatetxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillLastNametxt(string text)
		{
			LastNametxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillFirstNametxt(string text)
		{
			FirstNametxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillMiddleNametxt(string text)
		{
			MiddleNametxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillDob_txtDatectl(string text)
		{
			Dob_txtDatectl.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillDoNInvitationDate_txtDatectl(string text)
		{
			DoNInvitationDate_txtDatectl.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillIIO_InvitationSentDatetxt(string text)
		{
			IIO_InvitationSentDatetxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillIIO_DossierSentDatetxt(string text)
		{
			IIO_DossierSentDatetxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillConsentProviderNametxt(string text)
		{
			ConsentProviderNametxt.SendKeys(text);
			return this;
		}
		public ClientInformationAutoGen FillDateFieldNoTransferConfirmedDate_txtDate(string text)
		{
		...
		//	return new Place_Holder(Driver);
		//}
		public ClientInformationAutoGen ClickSavelnk()
		{

			Savelnk.Click();
			DriverHelper.WaitForPageLoad(Driver);
            if (IIO_TransitionCodetxt.Text == "")
            {
				Savelnk.Click();
				DriverHelper.WaitForPageLoad(Driver);
			}
		...
		//	return new Place_Holder(Driver);
		//}
		public ApplicationListAutoGen ClickApplicationslnk()
		{
			Applicationslnk.Click();
			return new ApplicationListAutoGen(Driver);
		}
	}
}
